 ...
 * @since 4.0
 */
public class PatriciaTrieTest<V> extends AbstractSortedMapTest<CharSequence, V> {
    ...
    @Override
    public SortedMap<CharSequence, V> makeObject() {
    ...
    public void testPrefixMap() {
        ...
        SortedMap<CharSequence, String> map;
        Iterator<String> valIterator;
        Iterator<CharSequence> keyIterator;
        Iterator<Map.Entry<CharSequence, String>> entryIterator;
        ...
        valIterator = map.values().iterator();
        Assert.assertEquals("Alabama", valIterator.next());
        Assert.assertEquals("Albert", valIterator.next());
        Assert.assertEquals("Alberto", valIterator.next());
        Assert.assertEquals("Albertoo", valIterator.next());
        Assert.assertEquals("Alberts", valIterator.next());
        Assert.assertEquals("Alien", valIterator.next());
        Assert.assertEquals("Allie", valIterator.next());
        Assert.assertEquals("Alliese", valIterator.next());
        Assert.assertFalse(valIterator.hasNext());

        map = trie.prefixMap("Albert");
        keyIterator = map.keySet().iterator();
        Assert.assertEquals("Albert", keyIterator.next());
        Assert.assertEquals("Alberto", keyIterator.next());
        Assert.assertEquals("Albertoo", keyIterator.next());
        Assert.assertEquals("Alberts", keyIterator.next());
        ...
        Assert.assertEquals("Albertoo", keyIterator.next());
        Assert.assertEquals("Alberts", keyIterator.next());
        Assert.assertEquals("Albertz", keyIterator.next());
        Assert.assertFalse(keyIterator.hasNext());
        ...
        valIterator = map.values().iterator();
        Assert.assertEquals("Xavier", valIterator.next());
        Assert.assertEquals("XyZ", valIterator.next());
        Assert.assertFalse(valIterator.hasNext());
        ...
        keyIterator = map.keySet().iterator();
        Assert.assertEquals("Anna", keyIterator.next());
        Assert.assertFalse(keyIterator.hasNext());
        ...
        keyIterator = map.keySet().iterator();
        Assert.assertEquals("Banane", keyIterator.next());
        Assert.assertFalse(keyIterator.hasNext());
        ...
        keyIterator = map.keySet().iterator();
        Assert.assertEquals("Amma", keyIterator.next());
        Assert.assertEquals("Ammun", keyIterator.next());
        Assert.assertFalse(keyIterator.hasNext());
        keyIterator = map.keySet().iterator();
        map.put("Amber", "Amber");
        Assert.assertEquals(3, map.size());
        ...
        Assert.assertEquals(2, map.size());
        keyIterator = map.keySet().iterator();
        Assert.assertEquals("Akka", keyIterator.next());
        Assert.assertEquals("Akko", keyIterator.next());
        Assert.assertFalse(keyIterator.hasNext());
    ...
    public void testPrefixMapRemoval() {
        ...
        SortedMap<CharSequence, String> map = trie.prefixMap("Al");
        Assert.assertEquals(8, map.size());
