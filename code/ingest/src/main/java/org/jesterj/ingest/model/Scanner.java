...
public interface Scanner extends Step {
     ...
     * scanning process. The default transformation is an identity transform. This feature may be important
     * for OpenSearch users. OpenSearch restricts Bulk operation id's to 512 bytes. Be very careful that your
     * transform cannot produce duplicate Id's among documents. If this seems difficult you may wish to
     * consider using Apache Solr, or patching OpenSearch (JesterJ cannot fix this questionable design
     * decision by OpenSearch).
     *
